...
export default function RecentBlogs({ id, title = 'Latest posts' }) {

    const { data: RecentblogsData, isLoading, isError, error } = useQuery({
        queryKey: [`Recentblogs`],
        queryFn: () => {
            return axios.get(`https://api.propxpro.com/api/landing/blogs/recent/added`)
        }
    })
