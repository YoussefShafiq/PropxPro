...
export default function BlogCard({ blog: i }) {
    ...
    return <>
        <div className="w-full h-full lg:w-[calc(33%-10px)] bg-white border rounded-2xl flex flex-col" onClick={() => navigate(`/blog/post/${i.id}`)} data-aos="fade-up" data-aos-offset="200">
