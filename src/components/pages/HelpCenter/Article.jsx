        ...
        <>
            ...
            <div className="bg-gray-200">
                <div className="container !py-5 flex flex-wrap items-center gap-3">
                    ...
                    <span className='hover:text-hoverText hover:underline cursor-pointer text-grayText text-opacity-80' onMouseDown={(e) => { e.stopPropagation(); navigate(`/help-center/category/${articleData?.data?.data?.category_id}`) }}>  {articleData?.data?.data?.category_name}</span>
                    {articleData?.data?.data && <><FaChevronRight size={10} /> <span className='' > {articleData.data.data.title}</span></>}
                </div>
            </div>
                ...
                {!isLoading && !isError && articleData?.data?.data && (
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="flex gap-2 items-center text-sm font-medium">
                            <div className="h-12 aspect-square rounded-full shadow">
                                <img src={articleData?.data?.data?.author?.profile_photo} alt={articleData?.data?.data?.author?.name} />
