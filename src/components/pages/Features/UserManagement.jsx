        ...
        <div className="container lg:!px-0 flex flex-col gap-10">
            <div className="flex flex-col lg:flex-row gap-10">
                <div className="lg:w-1/2 bg-[#fefaf5] rounded-xl flex flex-col lg:pt-14 pb-5 gap-10 overflow-hidden" >
                    ...
                    <div className="pe-14 m-0" data-aos="slide-right">
                        <img src={transformTeam} className='w-full' alt="Transform your team" loading='lazy' />
                    </div>
                </div>
                <div className="lg:w-1/2 bg-[#f6f5fe] rounded-xl flex flex-col justify-between lg:pt-14 gap-10 overflow-hidden"  >
                    ...
                    <div className="pe-20 m-0" data-aos="slide-left">
                        <img src={manageRoles} className='w-full' alt="Manage user roles" loading='lazy' />
                    </div>
                </div>
            </div>
            ...
            <div className="bg-[#fef5f5] rounded-xl flex flex-col lg:pt-14 p-5 pb-0 lg:px-14 gap-10 overflow-hidden" >
                ...
                <div className="m-auto w-full" data-aos="slide-up" >
                    <img src={stayInformed} className='w-full' alt="Stay Informed Instantly" loading='lazy' />
                </div>
            </div>
        </div>
    </>
