...
export function HeroSection() {
    return <>
        <div className="px-6 lg:px-20 m-auto text-center flex flex-col gap-8 items-center py-8 lg:py-28" >
...
export function Userfriendly() {
    return <>
        <div className="py-8 lg:p-16 px-6 lg:px-20 flex lg:flex-row flex-col gap-5 w-full items-center justify-between" data-aos="fade-up" data-aos-offset="200">
...
export function LeadManagement() {
    return <>
        <div className="p-16 px-6 lg:px-20 flex lg:flex-row flex-col gap-5  w-full items-center justify-between" data-aos="fade-up" data-aos-offset="200">
            <div className="lg:w-1/2 lg:pe-16">
...
export function RealTimeCommunication() {
    return <>
        <div className="p-8 lg:p-16 px-6 lg:px-20 flex  lg:flex-row flex-col gap-5  w-full items-center justify-between" data-aos="fade-up" data-aos-offset="200" >
            <div className="lg:w-1/2 lg:pe-16">
...
export function ChatsAndCalling() {
    return <>
        <div className="py-8 lg:p-16 px-6 lg:px-20 flex flex-col gap-10">
            <div className="flex flex-col lg:flex-row gap-10">
                <div className="lg:w-3/5 bg-[#fefaf5] rounded-xl flex flex-col pt-14 lg:pe-14 gap-10 overflow-hidden" >
                ...
                <div className="lg:w-2/5 bg-[#f6f5fe] rounded-xl flex flex-col pt-14 gap-10 overflow-hidden"  >
                    <div className="px-5 lg:px-14 ">
...
export function GettingStarted() {
    ...
    return <>
        <div className="p-8 lg:p-20 flex flex-col gap-10 bg-[#131e57] items-center" data-aos="fade-up" data-aos-offset="200">
...
export function EmpowerYourTeamAndActionAssignment() {
    return <>
        <div className="p-8 lg:p-16 pt-0.5 px-6 lg:px-20 flex lg:flex-row flex-col gap-10">
            <div className="w-full lg:w-3/5 bg-[#f6f5fe] rounded-xl flex flex-col pt-14  gap-10 overflow-hidden"   >
                <div className="px-5 lg:px-14">
            ...
            <div className="w-full lg:w-2/5 bg-[#fefaf5] rounded-xl flex flex-col pt-14  gap-10 overflow-hidden"   >
                <div className="px-5 lg:px-14 ">
...
export function StreamlineYourWorkflow() {
    return <>
        <div className="p-8 lg:p-20 pb-0 pt-32 flex flex-col lg:flex-row gap-10 bg-[#f5f9fe] justify-between items-end">
            ...
            <div className="w-full lg:w-2/5 min-w-[500px] flex overflow-hidden relative h-full items-end m-auto">
...
export function SimplifyChallenges() {
    return <>
        <div className="px-8 py-20 lg:px-20 flex flex-col gap-10 bg-[#131e57] items-center">
...
export function AgentFeedback() {
    return <>
        <div className="p-8 lg:p-20 py-24 flex flex-col lg:flex-row gap-12 items-center bg-[#f5f9fe]">
...
export function DiscoverFeatures() {
    ...
    return <>
        <div className="px-8 py-16 lg:p-20 flex flex-col text-center gap-14">
...
export default function Home() {
    ...
    return <>
        <HeroSection />
        <div className="px-6 lg:px-20 m-auto" data-aos="fade-up" >
