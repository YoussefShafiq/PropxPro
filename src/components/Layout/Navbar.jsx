            ...
            <div className="fixed z-50 top-0 left-0 right-0 bg-white hidden lg:flex justify-between items-center h-[84px] navbarpadding px-28 py-3 shadow">
                ...
                <div className="flex items-center gap-x-4 font-semibold">
                    ...
                    <div className="relative bg-black w-[145px] h-[50px] rounded-md">
                        <a href='https://dev.vtech-upgraded.com/signup' target='_blank' className="absolute left-0 hover:-translate-x-1.5 hover:-translate-y-1.5  hover:border-black border-[2px] border-transparent w-[145px] h-[50px] capitalize bg-lightBlue text-white transition-all duration-300 px-7 py-3 rounded-md min-w-max">get started</a>
                    </div>
            ...
            <div className="w-full h-[81px] fixed top-0 left-0 right-0 z-50 lg:hidden flex items-center justify-between px-8 bg-white shadow select-none">
                ...
                <AnimatePresence>
                    {phoneNavbar && (
                        <motion.div
                            ref={mobileMenuRef}
                            className="w-full fixed top-[81px] left-0 right-0 bg-white z-40 overflow-hidden shadow-md"
                            initial="closed"
                            animate="open"
                            exit="closed"
